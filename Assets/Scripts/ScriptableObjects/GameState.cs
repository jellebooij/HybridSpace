...
public struct GameState{
	...
	public bool Compare(GameState other){
		if(other.actor1InLight == actor1InLight && other.actor2InLight == actor2InLight && other.actor3InLight == actor3InLight  && other.actor4InLight == actor4InLight && decor == other.decor){
			return true;
		}
		return false;
	}
